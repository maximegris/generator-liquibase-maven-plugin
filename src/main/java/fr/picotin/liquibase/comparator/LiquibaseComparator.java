...
public class LiquibaseComparator implements Comparator<File> {
	...
	public int compare(File f1, File f2) {
		...
		if (StringUtils.isNotEmpty(filePatternCustomSort)) {

			final Pattern pattern = Pattern.compile(filePatternCustomSort);

			final Matcher fileMatcher1 = pattern.matcher(fileName1);
			final Matcher fileMatcher2 = pattern.matcher(fileName2);
